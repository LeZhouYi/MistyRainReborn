...
//import skily_leyu.mistyrain.tileentity.TileEntityPotBase;
//
...
//     * @return
//     */
//    public void updateCheckAnima(TileEntityPotBase potTileEntity, World worldIn, BlockPos pos, PlantStageType stageType) {
...
//                        if (checkEntity != null && checkEntity instanceof TileEntityPotBase) {
////                            gatherAnimas.addAll(((TileEntityPotBase) checkEntity).getGenAnima());
//                        }
//                    }
//                }
//                // 合并
...
//     * @return
//     */
//    public int consumerFerti(TileEntityPotBase tileEntity, Random rand) {
...
//     * @return
//     */
//    public int consumeWater(TileEntityPotBase tileEntity, Random rand) {
...
//     * @return
//     */
//    public int checkLight(TileEntityPotBase tileEntity, World worldIn, Random rand) {
...
//     * @return
//     */
//    public int checkTemper(TileEntityPotBase tileEntity, World worldIn, Random rand) {
...
//     * @param tileEntity
//     */
//    public void tick(TileEntityPotBase tileEntity) {
