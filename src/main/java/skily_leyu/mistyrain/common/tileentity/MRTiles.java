...
public class MRTiles {
    ...
    public static final RegistryObject<TileEntityType<TileWoodenPot>> woodenPotTileEntity = TILEENTITY_REGISTER
            .register("mr_wooden_pot_tileentity", () -> TileEntityType.Builder.of(
                    TileWoodenPot::new, MRBlocks.woodenPot
            ).build(null));
    public static final RegistryObject<TileEntityType<TileClayPot>> clayPotTileEntity = TILEENTITY_REGISTER
