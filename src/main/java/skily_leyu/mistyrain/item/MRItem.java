...
public class MRItem {
    ...
    public static RegistryObject<Item> itemGreenWisteria = ITEMS.register("mr_green_wisteria", () -> {
    ...
    public static RegistryObject<Item> itemClayPot = ITEMS.register("mr_clay_pot", () -> {
        return new BlockItem(MRBlock.blockClayPot.get(), new Item.Properties().tab(MRGroup.potPlantGroup));
    });
}